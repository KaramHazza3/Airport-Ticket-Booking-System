...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        // var flight1 = new Flight(country1, country2, airport1, airport2, DateTime.UtcNow, flightClasses);
        // var flight2 = new Flight(country2, country3, airport2, airport1, DateTime.Now, flightClasses);
        ...
        // var returnedBooking = await bookingService.AddAsync(booking1);
